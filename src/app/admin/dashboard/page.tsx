...
export default function AdminDashboardPage() {
  ...
  const modules = [
    ...
    { title: "📱 QR Code Generator with Logo", desc: "Generate luxury print-ready QR codes with AAREN logo or partner brand emblems. 100% direct access with zero redirect warning screens.", href: "/admin/qr-generator", icon: QrCode },
