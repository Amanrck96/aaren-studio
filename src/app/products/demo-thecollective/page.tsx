...
const PRODUCTS = [
  { id: 1, brand: "FORMICA", name: "FENIX NTM® SURFACE", price: "₹12,500", color: "Nero Ingo", imgFront: "/categories/cat_2.jpg", imgBack: "https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=800&q=80" },
  { id: 2, brand: "ALPI", name: "ALPI SIGNATURE VENEER", price: "₹24,000", color: "Smoked Oak", imgFront: "/categories/cat_1.jpg", imgBack: "https://images.unsplash.com/photo-1533090161767-e6ffed986c88?auto=format&fit=crop&w=800&q=80" },
  { id: 3, brand: "INCLASS", name: "INCLASS HPL LAMINATE", price: "₹8,500", color: "Brushed Brass", imgFront: "/categories/cat_3.jpg", imgBack: "https://images.unsplash.com/photo-1588854337236-6889d631faa8?auto=format&fit=crop&w=800&q=80" },
  { id: 4, brand: "FORMICA", name: "DECOMETAL SURFACING", price: "₹16,500", color: "Rose Gold", imgFront: "/categories/cat_4.jpg", imgBack: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=800&q=80" },
];
