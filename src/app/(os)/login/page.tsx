    ...
    <>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .os-login{min-height:100vh;background:#08111F;display:flex;flex-direction:column;}
        ...
        .os-card{width:100%;max-width:420px;background:#101C30;border:1px solid rgba(255,255,255,.08);border-radius:20px;padding:36px;box-shadow:0 8px 40px rgba(0,0,0,.45);}
        ...
        .os-forgot{background:none;border:none;color:#7C3AED;font-size:12px;font-weight:600;cursor:pointer;padding:0;font-family:inherit;}
        .os-forgot:hover{color:#a078f0;}
        ...
        .os-footer a:hover{color:#a078f0;}
        .os-modal-bg{position:fixed;inset:0;background:rgba(0,0,0,.7);backdrop-filter:blur(8px);display:flex;align-items:center;justify-content:center;z-index:100;padding:20px;}
        .os-modal{background:#101C30;border:1px solid rgba(255,255,255,.14);border-radius:20px;padding:28px;width:100%;max-width:400px;box-shadow:0 8px 40px rgba(0,0,0,.6);}
        .os-modal h3{font-size:16px;font-weight:800;color:#F8FAFC;margin-bottom:4px;}
        .os-modal p{font-size:12.5px;color:#93A2B8;margin-bottom:20px;line-height:1.6;}
        .os-modal-btns{display:flex;gap:10px;margin-top:16px;}
        .os-btn-ghost{padding:10px 16px;border-radius:9px;border:1px solid rgba(255,255,255,.12);background:transparent;color:#F8FAFC;font-size:12.5px;font-weight:600;cursor:pointer;font-family:inherit;}
        .os-success{background:rgba(34,197,94,.1);border:1px solid rgba(34,197,94,.25);border-radius:9px;padding:12px 14px;font-size:12.5px;color:#22C55E;font-weight:600;}
