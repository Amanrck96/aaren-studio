...
export default function CategoryShowroom({
  ...
  const logoImage = isHub
    ? DEFAULT_BRAND_LOGO
    : currentCategory.logoUrl || currentCategory.bannerImageUrl || "";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ══════════════════════════════════════
            1. HERO PROFILE CARD (MATCHING BRANDS)
            ══════════════════════════════════════ */}
        <header
          style={{
            position: "relative",
      ...
      {isHub ? (
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "16px", minWidth: 0, flex: 1 }}>
                    ...
                    >
                      {c.logoUrl || c.bannerImageUrl ? (
                        ...
                        <Layers style={{ width: 22, height: 22, color: "#81663F" }} />
                      )}
                    </div>
        ...
        /* ══════════════════════════════════════
            2. CATEGORY SHOWROOM: PDF CATALOGUES
            ...
            files.map((file, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Actions: View PDF [ ↗ ] AND Download Button */}
      ...
      {/* ══════════════════════════════════════
          3. CONTACT CARD (OFFICIAL BENGALURU)
             MATCHING BRANDS EXACTLY
          ══════════════════════════════════════ */}
      <section
        style={{
          width: "100%",
