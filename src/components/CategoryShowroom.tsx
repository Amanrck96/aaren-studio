  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ══════════════════════════════════════
            1. HERO PROFILE CARD (CLEAN CARD)
            ══════════════════════════════════════ */}
        <div
          style={{
            width: "100%",
                ...
                return (
                  <Link
                    ...
                    style={{
                      ...
                      backgroundColor: "#fff",
                      border: "1px solid rgba(0,0,0,0.05)",
                      boxShadow: "0 7px 29px rgba(100,100,111,0.15)",
                      textDecoration: "none",
                      gap: "12px",
                    }}
                  >
        ...
        {/* ══════════════════════════════════════
            4. CONTACT US CARD (OFFICIAL BENGALURU)
            ══════════════════════════════════════ */}
        <section
          style={{
            width: "100%",
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            ...
            >
              ...
              <div style={{ minWidth: 0, flex: 1 }}>
                <div style={{ fontSize: "10px", textTransform: "uppercase", fontWeight: 700, color: "#8A8275" }}>
                  Call Us
                </div>
                <div style={{ fontSize: "14px", fontWeight: 600, color: "#1E1E1E" }}>
                  8884464444
                </div>
              </div>
