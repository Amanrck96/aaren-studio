...
const BRANDS: Brand[] = [
  ...
  },
  {
    ...
    products: [
      { id: "nw-01", name: "Tali Deck", collection: "Decking", finish: "Teak Brown" },
      { id: "nw-02", name: "Thermory Cladding", collection: "Cladding", finish: "Charcoal" },
      { id: "nw-03", name: "Lattice Screen", collection: "Screens", finish: "Stone Grey" },
      { id: "nw-04", name: "Fence Panel", collection: "Fencing", finish: "Natural Oak" },
      { id: "nw-05", name: "Grooved Deck Board", collection: "Decking", finish: "Walnut" },
      { id: "nw-06", name: "3D Facade Panel", collection: "Cladding", finish: "Anthracite" },
    ],
    catalogues: [],
  },
  {
    ...
    founded: "1913",
    collections: ["All", "FENIX", "Decometal", "Cora", "ARPA", "Formica Global"],
    products: [
      { id: "fc-01", name: "FENIX NTM®", collection: "FENIX", finish: "Matte Nano-tech", tag: "Bestseller" },
      { id: "fc-02", name: "Decometal Chrome", collection: "Decometal", finish: "Metallic" },
      { id: "fc-03", name: "Cora Stone", collection: "Cora", finish: "Stone Effect" },
      { id: "fc-04", name: "ARPA Vis", collection: "ARPA", finish: "High Gloss" },
      { id: "fc-05", name: "Formica Woodgrain", collection: "Formica Global", finish: "Timber Effect" },
      { id: "fc-06", name: "FENIX Bianco Kos", collection: "FENIX", finish: "Arctic White Matte" },
      { id: "fc-07", name: "Decometal Copper", collection: "Decometal", finish: "Rose Gold" },
      { id: "fc-08", name: "Cora Marble", collection: "Cora", finish: "Calacatta Effect" },
    ],
    catalogues: [
  ...
  },
  {
    ...
    founded: "1990",
    collections: ["All", "Vanities", "Bathtubs", "Shower Systems", "Accessories"],
    products: [
      { id: "fp-01", name: "Area 12 Vanity", collection: "Vanities", finish: "Matte Lacquer", tag: "Flagship" },
      { id: "fp-02", name: "Wash.Me Basin", collection: "Vanities", finish: "Solid Surface" },
      { id: "fp-03", name: "Freestanding Bathtub", collection: "Bathtubs", finish: "Mineral Composite" },
      { id: "fp-04", name: "Shower Bench", collection: "Shower Systems", finish: "Teak" },
      { id: "fp-05", name: "Mirror Cabinet", collection: "Accessories", finish: "Backlit LED" },
      { id: "fp-06", name: "Corner Shelf", collection: "Accessories", finish: "Brass" },
    ],
    catalogues: [],
  },
  {
